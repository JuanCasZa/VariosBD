...
values
('Leche Alpina', 50, 3200.50, 'L�cteos', 'A1', 'Alpina'),
('Queso Campesino', 20, 7800.00, 'L�cteos', 'A1', 'Colanta'),
('Leche Colanta', 80, 3100.00, 'L�cteos', 'A1', 'Colanta'),
('Yogurt Alpina', 45, 2500.00, 'L�cteos', 'A1', 'Alpina'),
('Pan Bimbo', 60, 4500.00, 'Panader�a', 'B1', 'Bimbo'),
('Galletas Festival', 100, 2500.00, 'Panader�a', 'B1', 'Nabisco'),
('Jugo Hit', 200, 2500.00, 'Bebidas', 'C1', 'Postob�n'),
('Agua Cristal', 200, 1200.00, 'Bebidas', 'C1', 'Postob�n'),
('Gaseosa Colombiana', 150, 3200.00, 'Bebidas', 'C1', 'Postob�n'),
('Caf� Sello Rojo', 30, 12000.00, 'Caf�', 'D1', 'Nutresa'),
...
('Aceitunas La Espa�ola', 25, 8700.00, 'Enlatados', 'F3', 'La Espa�ola'),
...
/*1.*/
select count(*) as 'L�cteos' from productos
	where categoria='L�cteos';
/*2.*/
